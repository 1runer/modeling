...
[Materials]
  ...
  [./Pfinztaeler_Sst_Mech_DP]
    ...
    youngs_modulus = 1.932e10 # from triax
    yield_stress = '0 1.6e8 1 1.6e8 2 1.6e8' #'0 1.46e8 1 1.46e8 2 1.46e8' # empirical from triax, in range between 1.1e8 and 1.2e8 Pa
...
[AuxVariables]
  active = 'total_porosity mech_porosity returnmap_iter mises_stress elastic_strain plastic_strain total_strain mech_dissip Mod_Gruntfest_number mean_stress'
  [./stress_xy]
    order = CONSTANT
    family = MONOMIAL
  [../]
...
[AuxKernels]
  active = 'total_porosity mech_porosity returnmap_iter mises_stress elastic_strain_z plastic_strain_z total_strain_z mech_dissip Gruntfest_Number mean_stress'
  [./stress_xy]
    type = RankTwoAux
