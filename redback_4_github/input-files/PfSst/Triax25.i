[Mesh]
  type = FileMesh
  file = Mesh_PfSst_7_Medium_2.msh
...
[Materials]
  ...
  [./Pfinztaeler_Sst_NoMech]
    ...
    ar = 8 # lit value
    delta = 7.1e-3 # 1.25e-2 # No value = crash
  ...
  [./Pfinztaeler_Sst_Mech_DP]
    ...
    youngs_modulus = 1.742e10 # from triax
    yield_stress = '0 1.12e8 1 1.12e8 2 1.12e8' # empirical from triax, in range between 1.1e8 and 1.2e8 Pa
...
[AuxVariables]
  active = 'total_porosity mech_porosity returnmap_iter mises_stress elastic_strain plastic_strain total_strain mech_dissip Mod_Gruntfest_number'
  [./total_porosity]
    order = FIRST
    family = MONOMIAL
  [../]
...
[AuxKernels]
  active = 'total_porosity mech_porosity returnmap_iter mises_stress elastic_strain_z plastic_strain_z total_strain_z mech_dissip Gruntfest_Number'
  [./total_porosity]
...
[Postprocessors]
  active = 'max_returnmap_iter elastic_strain_z plastic_strain_z total_strain_z mises_stress temperature_avg Mech_dissip_avg Mod_Gruntfest_avg temperature_core Mech_dissip_core Mod_Gruntfest_core'
  [./max_returnmap_iter]
